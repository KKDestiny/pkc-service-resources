...
(function () {
  ...
  Renderer.prototype.code = function (code, lang = "", escaped) {
    // User Prism
    let langName = escape(lang, true);
    if (!Prism.languages[langName]) {
      if (Prism.languages.vim) {
        langName = "vim";
      } else {
        langName = Object.keys(Prism.languages)[0];
      }
    }
    const html = Prism.highlight(code, Prism.languages[langName], langName);
    return (
      '<pre class="language-x"><code class="language-' +
      langName +
      '">' +
      html +
      "\n</code></pre>\n"
    ...
    if (!lang) {
      return (
        '<pre class="language-vim code-toolbar"><code>' +
  ...
  Renderer.prototype.image = function (href, title, text) {
    if (href) {
      href = href.replace("http://www.onelib.biz", "https://www.onelib.biz");
      href = href.replace("https://onelib.biz:888", "https://www.onelib.biz");
    }
    var out = '<img src="' + href + '" alt="' + text + '"';
    if (this.options.lazyload) {
      out = '<img class="lazy" data-original="' + href + '" alt="' + text + '"';
    }
