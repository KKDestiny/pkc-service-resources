...
(function () {
  ...
  function getDefaultOpts(simple) {
    ...
    var defaultOptions = {
      ...
      tasklistsStyle: {
        defaultValue: "switch",
        describe: "Check style in tasklist",
        type: "string",
      },
      enableChange: {
        defaultValue: true,
        describe: "Enable change option after rendered",
        type: "boolean",
      },
      smoothLivePreview: {
        defaultValue: false,
  ...
  showdown.subParser("codeBlocks", function (text, options, globals) {
    ...
    text = text.replace(pattern, function (wholeMatch, m1, m2) {
      ...
      codeblock =
        '<pre class="language-x"><code>' + codeblock + end + "</code></pre>";
  ...
  showdown.subParser("githubCodeBlocks", function (text, options, globals) {
    ...
    text = text.replace(
      ...
      function (wholeMatch, delim, language, codeblock) {
        ...
        let prismText = codeblock;
        try {
          prismText = Prism.highlight(
            codeblock,
      ...
      listStr = listStr.replace(
        ...
        function (wholeMatch, m1, m2, m3, m4, taskbtn, checked) {
          ...
          if (taskbtn && options.tasklists) {
            const inputStyle =
              options.tasklistsStyle === "switch"
                ? "margin: 5px 0.35em 0.25em -1.6em;"
            ...
            const inputClass =
              options.tasklistsStyle === "switch"
                ...
                : "";
            const liStyle =
              options.tasklistsStyle === "switch" ? "margin-left:-46px;" : "";
            bulletStyle =
              ...
              liStyle +
              '"';
            const diasbled = options.enableChange
              ? ""
              : "disabled = 'disabled' ";
            item = item.replace(/^[ \t]*\[(x|X| )?]/m, function () {
              var otp =
                '<input type="checkbox" ' +
                diasbled +
                ' class="form-check-input" role="switch" style="' +
                inputStyle +
          ...
          const inputClass = options.tasklists
            ? "name='showdown-tasklist'"
            : "";
          item =
            "<li " + inputClass + " " + bulletStyle + ">" + item + "</li>\n";
